      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-sm font-mono" style={{ color: "#888" }}>
                {fir.fir_number}
              </p>
            </div>
            ...
            <button
              onClick={downloadPDF}
              className="flex items-center gap-2 text-white font-semibold px-5 py-3 rounded-xl transition-all text-sm"
              style={{
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: "0 2px 16px rgba(26,77,46,0.04)"
          }}
        >
          ...
          <div className="grid grid-cols-2 gap-5">
            {[
              ...
              <div key={i} className="p-3 rounded-xl" style={{ backgroundColor: "#faf7f2" }}>
                <p className="text-[11px] font-semibold uppercase tracking-wider mb-1" style={{ color: "#aaa" }}>
                  {item.label}
                </p>
        ...
        >
          ...
          <div className="rounded-xl p-4" style={{ backgroundColor: "#faf7f2" }}>
            <pre className="text-sm leading-relaxed whitespace-pre-wrap" style={{ color: "#444", fontFamily: "inherit" }}>
              {fir.fir_text}
            </pre>
          </div>
        </motion.div>
        ...
        <motion.button
          ...
          style={{
            backgroundColor: "#1a4d2e",
            boxShadow: "0 8px 32px rgba(26,77,46,0.2)"
          }}
        >
          📄 Download PDF
        </motion.button>
